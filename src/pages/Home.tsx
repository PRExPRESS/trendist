...
const Home = () => {
  return (
    <div className='w-full h-full flex flex-col'>
      ...
      <div className="flex flex-col md:grid  md:grid-cols-3 md:gap-8 w-full h-full md:h-[700px] mt-8 md:px-4">
        <div className=" flex flex-col md:col-span-1 w-full h-full md:h-[700px] overflow-hidden">
          <AnimatePresence>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        <div className="flex flex-col md:col-span-1 w-full h-full md:h-[700px] ">
          <div className="row-span-1 w-full h-full overflow-hidden" >
            <AnimatePresence>
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
          ...
          <div className=" md:row-span-1 w-full h-full mt-[0px] overflow-hidden">
            <AnimatePresence>
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
      ...
      <div className="w-full flex flex-col md:flex-row md:h-screen justify-center items-center px-10 mt-8">
        <div className="flex flex-col justify-center md:w-5/12 items-start">
      ...
      <div className="w-full h-full items-center justify-center flex flex-col mt-[100px] px-8 ">
        <h1 className='text-black text-3xl font-normal'>Featured Collections</h1>
        <div className="flex flex-row w-full justify-center mt-10">
         <FeatureProducts />
        </div>
      </div>
      <div className="w-full h-full flex flex-row justify-around items-center mt-[100px] mb-[50px] px-8  gap-4">
